...
La connaissance scientifique est devenue si vaste qu'il est devenu impossible d'être un-e expert-e sur tout
(alors que c'était quasiment possible à son époque pour un génie comme Léonard de Vinci).
Même dans leur propre domaine d'expertise, les plus grands noms de notre époque
(que sont les médaillés Fields en mathématiques ou les champions du monde d'échecs),
...
car il est peut probable que tou-te-s les contributeurs/trices arrivent au même moment
...
(comme dans le concours MathWorks).
...
c'est une problématique importante dans le domaine littéraire en particulier[^littérature]
...
la mise à disposition par les chercheurs eux-mêmes de *documents de travail* et de *preprints*
(version de l'article avant le travail d'édition effectué par la revue elle-même) sur des portails ouverts ;
l'apparition de revues ouvertes qui ne se financent pas en vendant des abonnements et en restreignant l'accès
mais par d'autres moyens (par exemple en facturant l'acte de publication directement aux auteurs).
...
Les scientifiques eux-mêmes peuvent avoir intérêt à faire cette démarche de mettre en ligne leurs articles
dans une version non-finale pour plusieurs raisons : atteindre un public plus large, obtenir des citations supplémentaires
et s'assurer d'être les premiers à publier un résultat inédit.

Des tentatives d'y adjoindre des sortes de relectures ont eu lieu.
Une idée persistante est notamment d'en finir avec la relecture anonyme et d'encourager les chercheurs à écrire
...
si les collègues critiqués se retrouvent ensuite à devoir évaluer l'article ou la demande de financement
du chercheur auteur des critiques.

Pour en savoir plus sur l'*open access*, je recommande la lecture de cette page par Pablo Rauzy.

Le principe de l'*open data* est de rendre librement accessible les données récoltée pour une étude scientifique,
soit immédiatement, soit au moment de la publication.
Ces données peuvent alors à d'autres chercheurs dans de nouvelles analyses.

Enfin, certains chercheurs vont plus loin en partageant l'état de leur recherche, quasiment en direct,
sur leur blog (ce qu'on peut qualifier de *recherche ouverte* ou *recherche en public*).
Certains blogs de chercheurs connus reçoivent alors des milliers de visiteurs,
...
####L'implication des citoyens rendue possible

Les sciences citoyennes ne sont pas un phénomène nouveau
(par exemple, ce sont souvent des amateurs qui découvraient de nouvelles comètes)
mais Internet rend l'implication des citoyens beaucoup plus facile.
Les amateurs peuvent intervenir de plusieurs façons : en collectant et traitant de grands volumes d'information,
mieux que les ordinateurs (Galaxy Zoo) et parfois mieux que les experts du domaine eux-mêmes (FoldIt) ;
en repérant les anomalies et ce qui est digne d'attention
et en faisant parfois eux-mêmes un véritable travail de recherche[^pois] ;
en compilant la littérature (Open Dinosaure Project).
Enfin, lorsque les amateurs eux-mêmes ne sont plus assez nombreux pour traiter l'énorme volume de données disponibles,
...
Un projet comme Open Dinausaure Project n'aurait pas été possible sans *open access*.
...
Les sciences citoyennes sont attrayantes car elles sont un moyen efficace d'utiliser le "surplus de temps disponible"
...
Pour autant, il est très dur de savoir à quel point les sciences citoyennes vont impacter la manière
...
Lorsque les citoyens deviennent de véritables scientifiques et font de la vraie recherche
(par opposition à seulement y contribuer sur des tâches spécifiques et répétitives),
ils ont besoin de systèmes d'auto-formation, de communautés et de mentors pour coopérer et progresser.
...
par les médias grand public existe cependant. L'auteur n'est pour autant pas inquiet car, d'après lui,
...
Les scientifiques ne sont actuellement valorisés que lorsqu'ils écrivent des articles scientifiques.
Ils passent aussi une grosse partie de leur temps à chercher des financements
(principalement en rédigeant des candidatures pour des *grants*).
Par manque de temps et de valorisation, rares sont ceux qui contribuent à Wikipédia,
documentent des programmes qu'ils auraient programmés en vue de les partager, ou maintiennent des blogs actifs.
...
Puisque les scientifiques sont essentiellement récompensés par leur réputation
...
et en mesurant le nombre de citations recueillies par un auteur pour tous ses travaux,
