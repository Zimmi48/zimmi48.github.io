...
Pour en savoir plus sur l'*open access*, je recommande la lecture de [ce dossier](http://pablo.rauzy.name/openaccess/introduction.html) par Pablo Rauzy.
